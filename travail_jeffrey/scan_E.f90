...
delr=(xmax-xmin)/(npos-1)
 ...
 call pot_spec(pot(1,:),pot(2,:),xmu12, npos,delr,xmin) !construction des 2 potentiels de H2+ et du moment dipolaire
    ...
    !$omp PARALLELDO  default(none) private(E0,iE0,id) shared(title,pulsetype,wir,phase,le0wattcm2,tc,te,tf,logfile,t,ep,npos,v,x,dt,nt,xmu12,pot,delr,chi1,chi2,massreduite,pbfin,dE0,E0min,nE0) 
    do iE0=1,nE0
