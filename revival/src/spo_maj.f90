...
!!!!!!  ajouter 
      ...
      subroutine  calc_pulse(pulset,t,tc,te,E0)
          real(8) :: t,tc,E0,pulset,te
 if (t.lt.tc) then
            pulset=0.d0
    ...
    subroutine calc_champ(champ,pulset,wir,t,tc,phase)
        real(8) :: champ, pulset, wir, t, tc, phase
                champ=-dcos(wir*(t-tc)+phase)*pulset
